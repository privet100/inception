...
+ [install debian 12](https://www.debian.org/ "скачать debian")
  ...
  - user akostrik
+ ssh
  - Virtualbox -> настройки -> сеть -> дополнительно -> проброс портов (на школьном маке 22 занят ssh хостовой машины) (80 и 443 только чтобы с хостовой машины заходить на сайт):
