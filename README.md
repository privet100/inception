...
+ wordpress/Dockerfile
  ...
  - `sed -i ...` редактируют конфигурационный файл PHP-FPM для изменения настроек:
    * смена адреса прослушивания PHP-FPM с 127.0.0.1:9000 на просто 9000, что важно для корректной работы с Nginx.
    * устанавливаются владельцы и группа для сокета listen.owner и listen.group, чтобы процессы работали с правильными правами
