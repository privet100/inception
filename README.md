...
+ wordpress/wp-config-create.sh 
  ...
  - require_once ABSPATH . 'wp-settings.php';
    ...
    * 'wp-settings.php' один из ключевых файлов WordPress,  используется для инициализации и настройки всей системы, отвечает за инициализацию ядра WordPress: загружает необходимые файлы, настраивает глобальные переменные, настраивает среду WordPress, загружает плагины, активирует темы, выполняет другие важные шаги по настройке WordPress
