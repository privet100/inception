...
* распределить действия 
  ...
  + docker-compose
    ...
    - определение нескольких контейнеров (например, веб-приложение, база данных, кеш)
    ...
    ```
  + Dockefile
    - как собирать контейнер
    - создание рабочей среды, установки зависимостей, сборки приложения
    - установка зависимостей (например, с использованием RUN apt-get install)
    - копирование исходного кода в контейнер
    - определение команды по умолчанию для запуска приложения
  + скрипты
    - специфические задачи, сложные для описания в Makefile или Dockerfile
    - задачи, связанные с тестированием, миграциями базы данных, сборкой артефактов, настройками окружения
